defmodule BelleDonutsWeb.CoreComponents do
  @moduledoc """
  ...
  A `%HTML.Form{}` and field name may be passed to the input
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(BelleDonutsWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(BelleDonutsWeb.Gettext, "errors", msg, opts)
    end
  end
